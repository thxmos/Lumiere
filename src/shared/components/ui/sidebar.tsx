...
import { useIsMobile } from "@/shared/hooks/ui/use-mobile";
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-[--sidebar-width] bg-background text-foreground p-0 border-l"
            style={
              {
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "p-2 group-data-[collapsible=icon]:px-1",
        className,
      )}
      {...props}
    />
